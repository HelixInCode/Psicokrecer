      ...
      <main>
        <section id="articulo">
          <div class="contenedor-principal" style="padding-left: 0;">
            ...
            <div class="space2">
              <textarea name="subtitulo" style=" color:#68217e ; font-family: 'Varela Round', sans-serif; background-color: #fff0; border: #665b5b00; height: 200px;" id="first-p">
            ...
            <div class="space2">
              <textarea name="subtitulo" style=" color:#68217e ; font-family: 'Varela Round', sans-serif; background-color: #fff0; border: #665b5b00; height: 200px;">
