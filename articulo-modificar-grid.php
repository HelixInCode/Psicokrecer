      ...
      <main>
        <section id="articulo">
          <div class="contenedor-principal" style="padding-left: 0;">
            ...
            <div class="space1">
              <input type="text" name="titulo" value="<?php echo $posteo['titulo']; ?>" style="font-family: 'Julius Sans One', sans-serif; color:#68217e ;background-color: #fff0; border: #665b5b00; text-align: center; font-size: 20px;">
              <a><i id="icono-editar" class="fas fa-pencil-alt"></i></a>
            </div>

            <div class="space2">
              <textarea name="subtitulo" style=" color:#68217e ; font-family: 'Varela Round', sans-serif; background-color: #fff0; border: #665b5b00; height:50px">
            ...
            <div class="space2">
              <textarea name="parrafo1" id="first-p" style=" color:#68217e ; font-family: 'Varela Round', sans-serif; background-color: #fff0; border: #665b5b00; height:200px">
            ...
            <div class="space2">
              <textarea name="parrafo2" style=" color:#68217e ; font-family: 'Varela Round', sans-serif; background-color: #fff0; border: #665b5b00; height:200px">
            ...
            <div class="space2">
              <textarea name="parrafo3" style=" color:#68217e ; font-family: 'Varela Round', sans-serif; background-color: #fff0; border: #665b5b00; height:200px">
