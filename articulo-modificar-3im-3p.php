          ...
          <div class="contenedor-principal">
            ...
            <div class="space2">
              <textarea name="subtitulo" style=" color:#68217e ; font-family: 'Varela Round', sans-serif; background-color: #fff0; border: #665b5b00; height:50px">
                <?php echo $posteo['subtitulo']; ?></textarea>
              <a><i id="icono-editar" class="fas fa-pencil-alt"></i></a>
            </div>
            ...
            <div class="space2">
              <textarea name="parrafo1" style=" color:#68217e ; font-family: 'Varela Round', sans-serif; background-color: #fff0; border: #665b5b00; height:200px">
